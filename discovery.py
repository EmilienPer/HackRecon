...
def host_tree_to_html(ip_address, host_tree, base):
    ...
    etree.SubElement(head, "title").text = "Discovery: {}".format(ip_address)
    if CSS:
    ...
    etree.SubElement(body, "h1", attrib={"align": "center"}).text = "Discovery: {}".format(ip_address)
    os_name = ""
    accuracy = 0
    ...
    etree.SubElement(body, "p").text = "Report generated by Discovery (Tool created by Emilien Peretti)"
...
if __name__ == "__main__":
    ...
    logging.basicConfig(filename=os.path.join(args.out, "discovery.log"), level=logging.INFO)
